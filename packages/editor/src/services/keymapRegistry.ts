...
export const globalShortcutBindings: readonly GlobalShortcutBinding[] = [
    ...
    { action: 'openNewProjectModal', keys: ['n'], phase: 'global', preventDefault: 'always', requireMod: true, requireShift: true },
    { action: 'openProjectFolder', keys: ['o'], phase: 'global', preventDefault: 'always', requireAlt: true, requireMod: true },
    { action: 'openSettingsModal', keys: ['s'], phase: 'global', preventDefault: 'always', requireAlt: true, requireMod: true },
    { action: 'toggleTheme', keys: ['t'], phase: 'global', preventDefault: 'always', requireAlt: true, requireMod: true },
