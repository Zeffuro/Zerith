...
const labelStyle = { display: 'block', marginBottom: '6px', color: '#888', fontSize: '11px' };
const inputStyle = { width: '100%', padding: '8px', backgroundColor: '#1e1e1e', border: '1px solid #3c3c3c', color: '#fff', borderRadius: '4px', fontSize: '13px', outline: 'none' };