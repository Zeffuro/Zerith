import { createDesktopPackagingReadinessReport } from '../../services/desktopPackagingReadiness';
import { editorTheme as t } from '../../theme/editorTheme';

type DesktopPackagingReadinessPanelProperties = {
    uiScale: number;
};

export function DesktopPackagingReadinessPanel({ uiScale }: DesktopPackagingReadinessPanelProperties) {
...
function statusPillStyle(uiScale: number, status: 'blocked' | 'ready') {
